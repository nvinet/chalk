...
CREATE TABLE `family_muscle_groups` (
	...
	`position` integer NOT NULL,
	`required_machine_count` integer DEFAULT 1 NOT NULL,
...
CREATE TABLE `session_requirements` (
	...
	`muscle_group_id` text NOT NULL,
	`position` integer NOT NULL,
	`required_machine_count` integer NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `set_entries_unique_idx` ON `set_entries` (`session_id`,`machine_id`,`muscle_group_id`,`set_number`);--> statement-breakpoint
CREATE INDEX `set_entries_pairing_idx` ON `set_entries` (`machine_id`,`muscle_group_id`);--> statement-breakpoint
