...
One decision is still open and is listed in `docs/decisions.md`: whether body
weight and measurements are wanted at all (Q11), deliberately out of v1. It is a
question to ask, not to guess at.
